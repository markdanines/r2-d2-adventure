## R2-D2 Exercise - Challenge

## Startup
To start this application, navigate to the root folder in the terminal and run either "npm start" which will install all dependencies and start the application at the same time or you can do it separately by typing "npm install" to install the dependencies and then running the application by entering "node app".
